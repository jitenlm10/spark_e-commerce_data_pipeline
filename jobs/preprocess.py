...
def main():
    ...
    # ==========================================
    # 1. FORMAT 'EVENTS'
    # Required: user id, timestamp, event type, product id, session id, device, referrer
    # ==========================================
    print("Formatting events...")
    events_clean = events_raw.select(
    ...
    # ==========================================
    # 2. FORMAT 'ORDERS'
    # Required: order id, user id, timestamp, total amount
    # ==========================================
